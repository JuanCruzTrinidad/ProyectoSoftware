	...
	class WebSecurityConfig extends WebSecurityConfigurerAdapter {
		...
		protected void configure(HttpSecurity http) throws Exception {
			...
			http.csrf().disable()
				...
				.authorizeRequests()
				.antMatchers(HttpMethod.POST, "/user/login", "/user/newUser", "/user/recoverpw", "/user/resetpw", "/user/contactform", "/category/createCategory").permitAll()
				.antMatchers(HttpMethod.GET, "/user/login", "/product/allproduct", "/category/allcategories").permitAll()
